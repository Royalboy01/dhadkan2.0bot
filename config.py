...
BOT_NAME = getenv("BOT_NAME", "˹★[𝐃𝐡𝐚𝐝𝐤𝐚𝐧𝟐.𝟎𝐛𝐨𝐭]★˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "DhadkanMusic_Bot")
EVALOP = list(map(int, getenv("EVALOP", "6797202080").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1001562684739))
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
# External APIs - Get these from their respective providers
GPT_API = getenv("GPT_API")
DEEP_API = getenv("DEEP_API")
OWNER_ID = int(getenv("OWNER_ID", 5815972712))

# Heroku deployment settings - Refer to Heroku documentation on how to obtain these
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Royalboy01/dhadkan2.0bot")
...
PING_VID_URL = getenv(
    "PING_VID_URL", "https://graph.org/file/2e4fda0ee0905f04bbd32.jpg"
)
